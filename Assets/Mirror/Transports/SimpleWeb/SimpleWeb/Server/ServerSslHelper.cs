    ...
    internal class ServerSslHelper
    {
        ...
        public ServerSslHelper(SslConfig sslConfig)
        {
            ...
            if (config.enabled)
            {
                ...
                Log.Info(
                    $"[SWT-ServerSslHelper]: SSL Certificate {certificate.Subject} loaded with expiration of {certificate.GetExpirationDateString()}");
            }
        }
        ...
        bool acceptClient(object sender, X509Certificate certificate, X509Chain chain,
