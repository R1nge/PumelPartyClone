    ...
    public class WebSocketServer
    {
        ...
        public void Send(int id, ArrayBuffer buffer)
        {
            if (connections.TryGetValue(id, out Connection conn))
            {
                ...
                Log.Warn(
                    $"[SWT-WebSocketServer]: Cannot send message to {id} because connection was not found in dictionary. Maybe it disconnected.");
        }
        ...
        public string GetClientAddress(int id)
        {
            ...
            {
                Log.Warn(
                    $"[SWT-WebSocketServer]: Cannot get address of connection {id} because connection was not found in dictionary.");
                return null;
            }
        ...
        public Request GetClientRequest(int id)
        {
            ...
            {
                Log.Warn(
                    $"[SWT-WebSocketServer]: Cannot get request of connection {id} because connection was not found in dictionary.");
                return null;
            }
