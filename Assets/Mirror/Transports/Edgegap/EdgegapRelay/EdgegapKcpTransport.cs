...
namespace Edgegap
{
    ...
    public class EdgegapKcpTransport : KcpTransport
    {
        ...
        protected override void Awake()
        {
            ...
            config = new KcpConfig(DualMode, RecvBufferSize, SendBufferSize, MaxPayload, NoDelay, Interval, FastResend,
                false, SendWindowSize, ReceiveWindowSize, Timeout, MaxRetransmit);
