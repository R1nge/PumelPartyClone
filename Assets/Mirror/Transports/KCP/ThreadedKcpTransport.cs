...
namespace kcp2k
{
    ...
    public class ThreadedKcpTransport : ThreadedTransport, PortTransport
    {
        ...
        protected override void Awake()
        {
            ...
            config = new KcpConfig(DualMode, RecvBufferSize, SendBufferSize, MTU, NoDelay, Interval, FastResend,
                CongestionWindow, SendWindowSize, ReceiveWindowSize, Timeout, MaxRetransmit);
