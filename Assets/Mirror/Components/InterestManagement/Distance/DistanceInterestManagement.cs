...
namespace Mirror.Components.InterestManagement.Distance
{
    ...
    public class DistanceInterestManagement : Core.InterestManagement
    {
        ...
        readonly Dictionary<NetworkIdentity, DistanceInterestManagementCustomRange> CustomRanges =
            new Dictionary<NetworkIdentity, DistanceInterestManagementCustomRange>();
        ...
        {
            return CustomRanges.TryGetValue(identity, out DistanceInterestManagementCustomRange custom)
                ? custom.visRange
                : visRange;
        }
