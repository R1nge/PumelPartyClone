...
namespace Mirror.Weaver
{
    ...
    class NetworkBehaviourProcessor
    {
        ...
        Dictionary<FieldDefinition, (FieldDefinition hookDelegateField, MethodDefinition hookMethod)>
            syncVarHookDelegates =
                new Dictionary<FieldDefinition, (FieldDefinition hookDelegateField, MethodDefinition hookMethod)>();
        ...
        public NetworkBehaviourProcessor(AssemblyDefinition assembly, WeaverTypes weaverTypes,
            SyncVarAccessLists syncVarAccessLists, Writers writers, Readers readers, Logger Log, TypeDefinition td)
        {
        ...
        public bool Process(ref bool WeavingFailed)
        {
            ...
            (syncVars, syncVarNetIds, syncVarHookDelegates) =
                syncVarAttributeProcessor.ProcessSyncVars(netBehaviourSubclass, ref WeavingFailed);

            syncObjects =
                SyncObjectProcessor.FindSyncObjectsFields(writers, readers, Log, netBehaviourSubclass,
                    ref WeavingFailed);
        ...
        */
        public static void WriteClientActiveCheck(ILProcessor worker, WeaverTypes weaverTypes, string mdName,
            Instruction label, string errString)
        {
            // client active check
        ...
        */
        public static void WriteServerActiveCheck(ILProcessor worker, WeaverTypes weaverTypes, string mdName,
            Instruction label, string errString)
        {
            // server active check
        ...
        public static bool WriteArguments(ILProcessor worker, Writers writers, Logger Log, MethodDefinition method,
            RemoteCallType callType, ref bool WeavingFailed)
        {
            // write each argument
            // example result
            /*
        ...
        void InjectIntoStaticConstructor(ref bool WeavingFailed)
        {
            ...
            for (int i = 0; i < commands.Count; ++i)
            {
                ...
                GenerateRegisterCommandDelegate(cctorWorker, weaverTypes.registerCommandReference,
            ...
            for (int i = 0; i < clientRpcs.Count; ++i)
            {
                ...
                GenerateRegisterRemoteDelegate(cctorWorker, weaverTypes.registerRpcReference,
                    clientRpcInvocationFuncs[i], clientRpcResult.method.FullName);
            }
            ...
            {
                GenerateRegisterRemoteDelegate(cctorWorker, weaverTypes.registerRpcReference,
                    targetRpcInvocationFuncs[i], targetRpcs[i].FullName);
            }
        ...
        void InjectIntoInstanceConstructor(ref bool WeavingFailed)
        {
            ...
            foreach (KeyValuePair<FieldDefinition, (FieldDefinition, MethodDefinition)> entry in syncVarHookDelegates)
            {
                ...
                syncVarAttributeProcessor.GenerateSyncVarHookDelegateInitializer(ctorWorker, syncVarField, hookDelegate,
                    hookMethod);
            }
        ...
        */
        ...
        void GenerateRegisterRemoteDelegate(ILProcessor worker, MethodReference registerMethod, MethodDefinition func,
        ...
        void GenerateRegisterCommandDelegate(ILProcessor worker, MethodReference registerMethod, MethodDefinition func,
            CmdResult cmdResult)
        {
            // pass full function name to avoid ClassA.Func <-> ClassB.Func collisions
        ...
        void GenerateSerialization(ref bool WeavingFailed)
        {
            ...
            MethodReference baseSerialize =
                Resolvers.TryResolveMethodInParents(netBehaviourSubclass.BaseType, assembly, SerializeMethodName);
        ...
        void DeserializeField(FieldDefinition syncVar, ILProcessor worker, ref bool WeavingFailed)
        {
            ...
            if (syncVarHookDelegates.TryGetValue(syncVar,
                    out (FieldDefinition hookDelegateField, MethodDefinition) value))
            {
            ...
            else if (syncVar.FieldType.IsDerivedFrom<NetworkBehaviour>() || syncVar.FieldType.Is<NetworkBehaviour>())
            {
                ...
                MethodReference getFunc =
                    weaverTypes.generatedSyncVarDeserialize_NetworkBehaviour_T.MakeGeneric(assembly.MainModule,
                        syncVar.FieldType);
            ...
            else
            {
                ...
                MethodReference generic =
                    weaverTypes.generatedSyncVarDeserialize.MakeGeneric(assembly.MainModule, syncVar.FieldType);
        ...
        void GenerateDeSerialization(ref bool WeavingFailed)
        {
            ...
            // get dirty bits
            serWorker.Append(serWorker.Create(OpCodes.Ldarg_1));
            serWorker.Append(serWorker.Create(OpCodes.Call,
        ...
        public static bool ReadArguments(MethodDefinition method, Readers readers, Logger Log, ILProcessor worker,
            RemoteCallType callType, ref bool WeavingFailed)
        {
            // read each argument
            // example result
        ...
        bool ValidateParameter(MethodReference method, ParameterDefinition param, RemoteCallType callType,
            bool firstParam, ref bool WeavingFailed)
        {
            ...
            ref bool WeavingFailed)
        {
            ...
            MethodDefinition rpcCallFunc = RpcProcessor.ProcessRpcCall(weaverTypes, writers, Log, netBehaviourSubclass,
                md, clientRpcAttr, ref WeavingFailed);
            ...
            MethodDefinition rpcFunc = RpcProcessor.ProcessRpcInvoke(weaverTypes, writers, readers, Log,
                netBehaviourSubclass, md, rpcCallFunc, ref WeavingFailed);
            if (rpcFunc != null)
            {
            ...
            ref bool WeavingFailed)
        {
            ...
            MethodDefinition rpcCallFunc = TargetRpcProcessor.ProcessTargetRpcCall(weaverTypes, writers, Log,
                netBehaviourSubclass, md, targetRpcAttr, ref WeavingFailed);

            MethodDefinition rpcFunc = TargetRpcProcessor.ProcessTargetRpcInvoke(weaverTypes, readers, Log,
                netBehaviourSubclass, md, rpcCallFunc, ref WeavingFailed);
            if (rpcFunc != null)
            {
            ...
            ref bool WeavingFailed)
        {
            ...
            MethodDefinition cmdCallFunc = CommandProcessor.ProcessCommandCall(weaverTypes, writers, Log,
                netBehaviourSubclass, md, commandAttr, ref WeavingFailed);

            MethodDefinition cmdFunc = CommandProcessor.ProcessCommandInvoke(weaverTypes, readers, Log,
                netBehaviourSubclass, md, cmdCallFunc, ref WeavingFailed);
            if (cmdFunc != null)
            {
