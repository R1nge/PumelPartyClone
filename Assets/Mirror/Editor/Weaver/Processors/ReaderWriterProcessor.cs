...
namespace Mirror.Editor.Weaver.Processors
{
    ...
    {
        public static bool Process(AssemblyDefinition CurrentAssembly, IAssemblyResolver resolver, Logger Log,
            Writers writers, Readers readers, ref bool WeavingFailed)
        {
        ...
        static void ProcessMirrorAssemblyClasses(AssemblyDefinition CurrentAssembly, IAssemblyResolver resolver,
            Logger Log, Writers writers, Readers readers, ref bool WeavingFailed)
        {
        ...
        static bool LoadMessageReadWriter(ModuleDefinition module, Writers writers, Readers readers,
            TypeDefinition klass, ref bool WeavingFailed)
        {
            bool modified = false;
        ...
        static void AddRuntimeInitializeOnLoadAttribute(AssemblyDefinition assembly, WeaverTypes weaverTypes,
        ...
        static void AddInitializeOnLoadAttribute(AssemblyDefinition assembly, WeaverTypes weaverTypes,
            MethodDefinition method)
        {
            // NOTE: previously we used reflection because according paul,
            // 'weaving Mirror.dll caused unity to rebuild all dlls but in wrong
        ...
        public static void InitializeReaderAndWriters(AssemblyDefinition currentAssembly, WeaverTypes weaverTypes,
            Writers writers, Readers readers, TypeDefinition GeneratedCodeClass)
        {
