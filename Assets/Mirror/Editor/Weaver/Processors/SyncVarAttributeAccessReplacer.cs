...
namespace Mirror.Editor.Weaver.Processors
{
    public static class SyncVarAttributeAccessReplacer
    {
        ...
        static int ProcessInstruction(Logger Log, SyncVarAccessLists syncVarAccessLists, MethodDefinition md,
            Instruction instr, int iCount)
        {
        ...
        static void ProcessSetInstruction(SyncVarAccessLists syncVarAccessLists, MethodDefinition md, Instruction i,
        ...
        static void ProcessGetInstruction(SyncVarAccessLists syncVarAccessLists, MethodDefinition md, Instruction i,
            FieldDefinition opField)
        {
            // don't replace property call sites in constructors
            if (md.Name == ".ctor")
        ...
        static int ProcessLoadAddressInstruction(SyncVarAccessLists syncVarAccessLists, MethodDefinition md,
            Instruction instr, FieldDefinition opField, int iCount)
        {
            // don't replace property call sites in constructors
            if (md.Name == ".ctor")
                return 1;
