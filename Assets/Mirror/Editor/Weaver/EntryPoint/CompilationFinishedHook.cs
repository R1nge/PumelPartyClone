...
namespace Mirror.Weaver
{
    public static class CompilationFinishedHook
    {
        ...
        public static void OnCompilationFinished(string assemblyPath, CompilerMessage[] messages)
        {
            ...
            string unityEngineCoreModuleDLL =
 ...
 AssemblyDefinition.ReadAssembly(assemblyPath, new ReaderParameters{ ReadWrite = true, ReadSymbols =
 true, AssemblyResolver = asmResolver }))
            {
