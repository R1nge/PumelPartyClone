...
namespace Mirror.Editor.Weaver
{
    ...
    internal class Weaver
    {
        ...
        bool WeaveNetworkBehavior(TypeDefinition td)
        {
            ...
            {
                modified |= new NetworkBehaviourProcessor(CurrentAssembly, weaverTypes, syncVarAccessLists, writers,
                    readers, Log, behaviour).Process(ref WeavingFailed);
            }
        ...
        public bool Weave(AssemblyDefinition assembly, IAssemblyResolver resolver, out bool modified)
        {
            ...
            try
            {
                ...
                modified = ReaderWriterProcessor.Process(CurrentAssembly, resolver, Log, writers, readers,
                    ref WeavingFailed);
                rwstopwatch.Stop();
                ...
                if (modified)
                {
                    ...
                    ReaderWriterProcessor.InitializeReaderAndWriters(CurrentAssembly, weaverTypes, writers, readers,
                        GeneratedCodeClass);
