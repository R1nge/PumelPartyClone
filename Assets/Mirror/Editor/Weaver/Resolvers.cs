...
namespace Mirror.Weaver
{
    ...
    {
        public static MethodReference ResolveMethod(TypeReference tr, AssemblyDefinition assembly, Logger Log,
            string name, ref bool WeavingFailed)
        {
            if (tr == null)
            {
        ...
        public static MethodReference ResolveMethod(TypeReference t, AssemblyDefinition assembly, Logger Log,
            System.Func<MethodDefinition, bool> predicate, ref bool WeavingFailed)
        {
        ...
        public static MethodReference TryResolveMethodInParents(TypeReference tr, AssemblyDefinition assembly,
            string name)
        {
            if (tr == null)
            {
