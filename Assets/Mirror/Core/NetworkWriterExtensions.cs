    ...
    public static class NetworkWriterExtensions
    {
        ...
        public static void WriteTransform(this NetworkWriter writer, Transform value)
        {
            ...
            else
            {
                ...
                Debug.LogWarning(
                    $"Attempted to sync a Transform ({value}) which isn't networked. Transforms without a NetworkIdentity component can't be synced.");
                writer.WriteUInt(0);
            }
        }
        ...
        public static void WriteGameObject(this NetworkWriter writer, GameObject value)
        {
            ...
            if (!value.TryGetComponent(out NetworkIdentity identity))
                Debug.LogWarning(
                    $"Attempted to sync a GameObject ({value}) which isn't networked. GameObject without a NetworkIdentity component can't be synced.");
