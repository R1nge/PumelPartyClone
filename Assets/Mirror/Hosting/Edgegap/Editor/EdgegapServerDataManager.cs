    ...
    public static class EdgegapServerDataManager
    {
        ...
        static EdgegapServerDataManager()
        {
            _serverDataStylesheet =
                AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Edgegap/Editor/EdgegapServerData.uss");
        }
        ...
        public static VisualElement GetServerDataVisualTree()
        {
            ...
            bool isReady = hasServerData &&
                           _serverData.GetServerStatus().IsOneOf(ServerStatus.Ready, ServerStatus.Error);
            ...
            if (hasServerData)
            {
                ...
                {
                    serverDataTree.Add(
                        EdgegapServerDataManagerUtils.GetInfoText(
                            "Additional information will be displayed when the server is ready."));
                }
            }
            else
            {
                serverDataTree.Add(
                    EdgegapServerDataManagerUtils.GetInfoText(
                        "Server data will be displayed here when a server is running."));
            }
