...
namespace Edgegap.Editor.Api
{
    ...
    public abstract class EdgegapApiBase
    {
        ...
        private readonly HttpClient
            _httpClient = new HttpClient(); // Base address set // MIRROR CHANGE: Unity 2020 support
        ...
        private StringContent CreateStringContent(string json = "{}") =>
            new StringContent(json, Encoding.UTF8,
                "application/json"); // MIRROR CHANGE: 'new()' not supported in Unity 2020

        private static HttpResponseMessage CreateUnknown500Err() =>
            new HttpResponseMessage(HttpStatusCode
                .InternalServerError); // 500 - Unknown // MIRROR CHANGE: 'new()' not supported in Unity 2020
