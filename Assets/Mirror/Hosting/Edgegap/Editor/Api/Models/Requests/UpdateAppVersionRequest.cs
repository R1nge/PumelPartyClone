...
namespace Mirror.Hosting.Edgegap.Editor.Api.Models.Requests
{
    ...
    public class UpdateAppVersionRequest
    {
        ...
        [JsonProperty("max_duration")] public int MaxDuration { get; set; } = 30;

        [JsonProperty("use_telemetry")] public bool UseTelemetry { get; set; } = true;

        [JsonProperty("inject_context_env")] public bool InjectContextEnv { get; set; } = true;

        [JsonProperty("whitelisting_active")] public bool WhitelistingActive { get; set; } = true;
        ...
        [JsonProperty("time_to_deploy")] public int TimeToDeploy { get; set; } = 15;
        ...
        {
            [JsonProperty("kind")] public string Kind { get; set; } = "Seat";

            [JsonProperty("sockets")] public int Sockets { get; set; } = 10;

            [JsonProperty("autodeploy")] public bool Autodeploy { get; set; } = true;

            [JsonProperty("empty_ttl")] public int EmptyTtl { get; set; } = 60;

            [JsonProperty("session_max_duration")] public int SessionMaxDuration { get; set; } = 60;
        }

        public class ProbeData
        {
            [JsonProperty("optimal_ping")] public int OptimalPing { get; set; } = 60;

            [JsonProperty("rejected_ping")] public int RejectedPing { get; set; } = 180;
        }
        ...
        public class EnvsData
        {
            ...
            [JsonProperty("is_secret")] public bool IsSecret { get; set; } = true;
        }
