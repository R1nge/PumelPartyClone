...
namespace Edgegap.Editor.Api.Models.Results
{
    public class StopActiveDeploymentResult
    {
        ...
        [JsonProperty("deployment_summary")] public DeploymentSummaryData DeploymentSummary { get; set; }
        ...
        public class DeploymentSummaryData
        {
            ...
            [JsonProperty("fqdn")] public string Fqdn { get; set; }
            ...
            [JsonProperty("removal_time")] public string RemovalTime { get; set; }

            [JsonProperty("elapsed_time")] public int ElapsedTime { get; set; }

            [JsonProperty("last_status")] public string LastStatus { get; set; }
            ...
            [JsonProperty("sessions")] public SessionData[] Sessions { get; set; }

            [JsonProperty("location")] public LocationData Location { get; set; }

            [JsonProperty("tags")] public string[] Tags { get; set; }

            [JsonProperty("sockets")] public string Sockets { get; set; }

            [JsonProperty("sockets_usage")] public string SocketsUsage { get; set; }
