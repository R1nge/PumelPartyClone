...
namespace Mirror.Hosting.Edgegap.Editor.Api.Models.Results
{
    ...
    {
        [JsonProperty("name")] public string AppName { get; set; }
        ...
        [JsonProperty("create_time")] public string CreateTimeStr { get; set; }

        [JsonProperty("last_updated")] public string LastUpdatedStr { get; set; }
    }
}